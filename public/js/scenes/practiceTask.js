...
export default class PracticeTask extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('cloud', './assets/imgs/cloud2.png');
        this.load.image('button', './assets/imgs/button.png');
        // lightning bolt power:
        this.load.image('powerOFFprac', './assets/imgs/lightning-bolt-80_empty_practice.png')
        this.load.image('powerONprac', './assets/imgs/lightning-bolt-80_filled_practice.png')
